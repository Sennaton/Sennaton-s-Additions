...
import com.sennaton.sennaton_additions.SennatonMob.Dice.FrozenDiceEntity;
import com.sennaton.sennaton_additions.SennatonMob.model.Dice.FrozenDiceModel;
...
public class FrozenDiceRenderer extends GeoEntityRenderer<FrozenDiceEntity> {
    ...
    public FrozenDiceRenderer(EntityRendererProvider.Context renderManager) {
        ...
        addRenderLayer(new GlowLayerDice(this, new ResourceLocation(Sennaton_Additions_Client.MODID, "textures/entity/nyna/frozen_dice.png")));
