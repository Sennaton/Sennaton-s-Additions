...
public class HauntedDiceEntity extends LoadedDiceEntity {
    ...
    //public HauntedDiceEntity(Level world) {
    //    super(MobInit.HAUNTED_DICE, world);
    //}
    ...
    public static HauntedDiceEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
        HauntedDiceEntity entityarrow = new HauntedDiceEntity(MobInit.HAUNTED_DICE, entity, world);
    ...
    public static HauntedDiceEntity shoot(LivingEntity entity, LivingEntity target, String variantP) {
        ...
        HauntedDiceEntity entityarrow = new HauntedDiceEntity(MobInit.HAUNTED_DICE, entity, entity.level());
    ...
    protected void doPostHurtEffects(LivingEntity pLiving) {
        ...
        pLiving.addEffect(new MobEffectInstance(MobEffects.WITHER, 140));
    }
